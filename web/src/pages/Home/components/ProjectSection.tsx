            ...
            landscape:grid landscape:grid-cols-2
              lg:landscape:grid lg:landscape:grid-cols-2  items-center max-w-300 mx-auto px-5">
                ...
                <div className="flex flex-col  ">
                    <h3 className={" mt-0 md:mt-15 xl:mt-20 lg:mt-20 font-bold  text-3xl md:portrait:text-4xl text-center md:portrait:text-start landscape:text-start lg:text-start" + headerColor}>OUR PROJECT</h3>
